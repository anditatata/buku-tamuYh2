        ...
        <div class="w-64 bg-gradient-to-b from-purple-600 via-purple-700 to-purple-800 text-white shadow-xl">
            ...
            <nav class="mt-8">
                <div class="px-4 space-y-2">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-purple-600 to-purple-700 shadow-lg' : 'hover:bg-gradient-to-r hover:from-purple-600/50 hover:to-purple-700/50' }}">
